title = "Pre-test Survey (Python)"
description = """In this pre-test survey, we collect basic information, your Python background, and your familiarity with large language models."""
...
questions = {
    ...
    "Background": [
        {
            "text": "Programming background: If you have taken programming courses, list all languages you learned. (Select all that apply)",
            "type": "multiple_choice",
            "options": ["Java", "C++", "C", "Python", "JavaScript", "Matlab", "R", "SQL", "I have not learned programming", "Other"]
        },
        {
            "text": "Programming frequency: How often do you program?",
            "type": "single_choice",
            "options": ["Almost daily", "Almost weekly", "Occasionally", "Rarely, almost never"]
        }
    ],
