...
STAGE_NAME_MAP = {
    ...
    "a1": "Complete Homework 1",
    "a2": "Complete Homework 2",
...
class ProbelmPageBuilder:
        ...
        with ui.header().classes("p-0 h-fit flex items-center") as header:
            ...
            def update_timer():
                ...
                if countdown_time >= 0:
                    ...
                    ui.notify("Time is up. Returning to home", position="center", level="warning")
    ...
    def build_question_page(self):
        ...
        ui.html("<h3>Problem List</h3>").classes("markdown-body")
    ...
    def build_status_tag(self):
        ...
        if self.course == "py":
            ...
            if not tried and not solved:
                html = f"<small>Not attempted</small>"
            elif tried and not solved:
                html = f"<small>In progress 💡</small>"
            else:
                html = f"<small>Passed ✅</small>"
        else:
            if not tried:
                html = f"<small>Not submitted</small>"
            else:
                html = f"<small>Submitted ✅</small>"
        ui.html(html)
    ...
    def build_answer_page(self):
        ...
        with ui.column().classes("flex item-center w-full h-full"):
            ...
            if self.show_answer:
                ...
                with ui.expansion("Click to view solution", on_value_change=log_show_answer).classes(
